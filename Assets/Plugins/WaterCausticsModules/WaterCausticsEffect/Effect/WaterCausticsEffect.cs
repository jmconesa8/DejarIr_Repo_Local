...
namespace MH.WaterCausticsModules {
    ...
    public class WaterCausticsEffect : MonoBehaviour {
        ...
        private class pID {
            ...
            readonly public static int _WCECF__WaterSurfaceAttenOffset = Shader.PropertyToID ("_WCECF__WaterSurfaceAttenOffset");
            readonly public static int _WCECF__WaterSurfaceAttenWide = Shader.PropertyToID ("_WCECF__WaterSurfaceAttenWide");
            ...
            readonly public static int _WCECF__NormalAttenIntensity = Shader.PropertyToID ("_WCECF__NormalAttenIntensity");
            readonly public static int _WCECF__TransparentBackside = Shader.PropertyToID ("_WCECF__TransparentBackside");
            readonly public static int _WCECF__WldObjMatrixOfVolume = Shader.PropertyToID ("_WCECF__WldObjMatrixOfVolume");
        ...
        private void setShaderGlobalValue () {
            ...
            Shader.SetGlobalFloat (pID._WCECF__IntensityMainLit, m_intensity * m_adjustMainLit * (m_useMainLight ? 1f : 0f));
            Shader.SetGlobalFloat (pID._WCECF__IntensityAddLit, m_intensity * m_adjustAddLit * (m_useAdditionalLights ? 1f : 0f));
