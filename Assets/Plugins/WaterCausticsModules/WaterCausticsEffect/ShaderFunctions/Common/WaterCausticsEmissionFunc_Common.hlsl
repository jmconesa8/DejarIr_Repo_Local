...
half3 WCE_emissionSyncCore(float3 WorldPos, half3 NormalWS, half3 BaseColor, half intensity = 1) {
    ...
    _WCECF__Scale, _WCECF__WaterSurfaceY, _WCECF__WaterSurfaceY + _WCECF__WaterSurfaceAttenOffset,
    _WCECF__WaterSurfaceAttenWide, _WCECF__IntensityMainLit * intensity, _WCECF__IntensityAddLit * intensity,
    _WCECF__ColorShift, _WCECF__LitSaturation, _WCECF__NormalAttenIntensity, _WCECF__NormalAttenPower, _WCECF__TransparentBackside);
