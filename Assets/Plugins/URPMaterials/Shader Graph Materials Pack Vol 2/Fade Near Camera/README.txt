...
Note that I used a custom chader that gets a Noise 3D function from the "3D Noise.hlsl" file so that I can map noise on
 all sides of the mesh without unwrapping the mesh.
