...
public class Fase2Puzzle3CanvasInteraction : MonoBehaviour
{
    // Script for Puzzle 3 in Fase 2
    ...
    public GameObject puzzleObjects3finalObject;
    ...
    private void Start()
    {
        ...
        if (puzzleObjects3finalObject.activeInHierarchy == true)
        {
            puzzleObjects3finalObject.SetActive(false);
        }
    ...
    public IEnumerator ScriptedSequence()
    {
        ...
        puzzleObjects3finalObject.SetActive(true);
        yield return new WaitForSeconds(0.5f);
        ...
        oasisWater.SetBool("Play", true);
        Debug.Log("Player has completed Puzzle 3 Fase 2");
    }
}
