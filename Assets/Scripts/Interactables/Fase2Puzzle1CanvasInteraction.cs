...
public class Fase2Puzzle1CanvasInteraction : MonoBehaviour
{
    // Script for Puzzle 1 in Fase 2
    ...
    {
        crBool = true;
        Debug.Log("Begin Puzzle 1 Fase 2");
        ...
        Debug.Log("Player has completed Puzzle 1 Fase 2");
    }
}
