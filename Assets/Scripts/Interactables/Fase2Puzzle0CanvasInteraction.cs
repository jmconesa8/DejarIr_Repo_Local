...
public class Fase2Puzzle0CanvasInteraction : MonoBehaviour
{
    // Script for Puzzle 0 in Fase 2
    ...
    {
        crBool = true;
        Debug.Log("Begin Puzzle 0 Fase 2");
        ...
        Debug.Log("Player has completed Puzzle 0 Fase 2");
    }
}
